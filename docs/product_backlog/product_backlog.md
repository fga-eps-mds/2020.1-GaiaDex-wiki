...
| EP08 | Histórico/Log  | Listar todas as atividades que um usuário fez (comentarios em posts, scans etc)                                                              | Want-      |
| EP09 | Minha Planta   | Planta que fora adicionada à coleção do usuário e está sendo cultivada pelo mesmo                                                            | Should     |
| EP10 | Marketplace    | Espaço onde o usuário pode comprar/vender produtos orgânicos                                                                                 | Want+      |
